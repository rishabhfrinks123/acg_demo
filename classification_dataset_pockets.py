    ...
    #     blister_img=image[value[1]:value[3],value[0]:value[2]]
        ...
        # if len(np.where(mask==255)[0])>int(os.getenv('segmentation_mask_threshold')):
            ...
            for key1,value1 in blister_dict[key].items():
                ...
                cropped_pocket=blister_img[value1[1]:value1[3],value1[0]:value1[2]]

                cv2.imwrite(save_dir+directory+'/'+str(key)+str(key1)+img,cropped_pocket)
...
img_dir='/home/frinks3/RISHABH/ACG/foreign_full/'
save_dir='/home/frinks3/RISHABH/ACG/foreign_tablet/'
